...
<x-app-layout title="Quotations">
    ...
    <div class="space-y-4">
        <x-filter-bar>
            ...
            {{-- Chakra Production vs Chakra App Studio, same split as the
                 Invoices list. --}}
            <div class="flex flex-wrap gap-2">
