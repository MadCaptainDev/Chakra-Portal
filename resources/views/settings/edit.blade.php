            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="signature_name" name="signature_name" type="text" class="mt-1 block w-full" value="{{ old('signature_name', $settings->signature_name) }}" required />
                        <x-input-error :messages="$errors->get('signature_name')" class="mt-2" />
                    </div>

                    <div class="mb-4">
                        <x-input-label for="signature_title" value="Signature Title" />
                        <x-text-input id="signature_title" name="signature_title" type="text" class="mt-1 block w-full" value="{{ old('signature_title', $settings->signature_title) }}" required />
