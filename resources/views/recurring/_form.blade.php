...
>
    ...
    <div class="mb-6">
        ...
        <p class="text-xs text-gray-500 mt-1">The first invoice will be generated (as pending approval) on or after this date.</p>
    </div>
    ...
    <div class="flex flex-wrap items-center gap-4">
        ...
        <a href="{{ route('recurring.index') }}" class="text-sm text-gray-600 hover:text-gray-900">Cancel</a>
    </div>
</div>
