...
HTML;
    ...
    * { box-sizing: border-box; }
    ...
    /* Sits in the blank space below the header -- it used to start at
       top:20mm/height:79mm, which put it directly behind (and visually
       colliding with) the 32pt heading and date text above. Moved down
       and shrunk (same 46:79 aspect ratio, so it isn't stretched) to
       clear that text entirely while still ending well above the items
       table. */
    .watermark {
        position: absolute;
        top: 42mm;
